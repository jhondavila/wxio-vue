  ...
  var $keyboard = ($.keyboard = function(el, options) {
    ...
    base.init = function() {
      ...
      base.isContentEditable =
        !/(input|textarea)/i.test(base.el.nodeName) &&
    ...
    base.reveal = function(redraw) {
      ...
      if (o.openOn) {
        base.$el.unbind(
          $.trim((o.openOn + " ").split(/\s+/).join(base.namespace + " "))
        );
      }
      ...
      if (
        !base.$keyboard ||
        (base.$keyboard &&
          (!base.$keyboard.length ||
            $.contains(base.el.ownerDocument.body, base.$keyboard[0])))
      ) {
        base.startup();
      }
      ...
      base.lineHeight =
        parseInt(base.$preview.css("lineHeight"), 10) ||
        parseInt(base.$preview.css("font-size"), 10) + 4;

      if (o.caretToEnd) {
        base.saveCaret(
          base.originalContent.length,
          base.originalContent.length
        );
      }
    ...
    base.updateLanguage = function() {
      ...
      o.wheelMessage =
        (kblang[lang] && kblang[lang].wheelMessage) || kblang.en.wheelMessage;
      // rtl can be in the layout or in the language definition; defaults to false
      o.rtl =
        (layouts[o.layout] && layouts[o.layout].rtl) ||
        (kblang[lang] && kblang[lang].rtl) ||
        false;

      // save default regex (in case loading another layout changes it)
      base.regex =
        (kblang[lang] && kblang[lang].comboRegex) || $keyboard.comboRegex;
    ...
    base.startup = function() {
      ...
      base.$keyboard.appendTo(
        o.appendLocally ? base.$el.parent() : o.appendTo || "body"
      );
    ...
    base.setScroll = function() {
      ...
      if (!base.isContentEditable && base.last.virtual) {
        var scrollWidth,
          ...
          value = base.last.val.substring(
            0,
            Math.max(base.last.start, base.last.end)
          );

        if (!base.$previewCopy) {
          // clone preview
          base.$previewCopy = base.$preview
            .clone()
        ...
        if (isTextarea) {
          ...
          base.$previewCopy.height(base.lineHeight).val(value);
          // set scrollTop for Textarea
          base.preview.scrollTop =
            base.lineHeight *
            (Math.floor(base.$previewCopy[0].scrollHeight / base.lineHeight) -
              1);
        } else {
          ...
          adjustment = /c/i.test(o.scrollAdjustment)
            ? base.preview.clientWidth / 2
            : o.scrollAdjustment;
    ...
    base.bindKeyboard = function() {
      ...
      base.$preview
        ...
        .bind("keypress" + namespace, function(e) {
          ...
          if (o.restrictInput) {
            ...
            if (
              (e.which === keyCodes.backSpace || e.which === 0) &&
      ...
      base.$keyboard.bind(
        "mousedown click touchstart ".split(" ").join(base.namespace + " "),
        function(e) {
          e.stopPropagation();
          if (!base.isCurrent()) {
            base.reveal();
    ...
    base.bindKeys = function() {
      var kbcss = $keyboard.css;
      base.$allKeys = base.$keyboard
        .find("button." + kbcss.keyButton)
        ...
        .bind(
          ...
          function(e) {
            ...
            if (
              (type === "mouseenter" || type === "touchstart") &&
              base.el.type !== "password" &&
            ...
            if (type === "mouseleave") {
              ...
              $this.removeClass(
                base.el.type === "password" ? "" : o.css.buttonHover
              );
              if (o.useWheel && base.wheel) {
                last.wheelIndex = 0;
                last.wheelLayers = [];
        ...
        .bind(
          o.keyBinding.split(" ").join(base.namespace + " ") +
            base.namespace +
            " " +
          ...
          function(e) {
            ...
            if (o.useWheel && base.wheel) {
              ...
              $key =
                $keys && last.wheelIndex > -1
                  ? $keys.eq(last.wheelIndex)
                  : $key;
            }
            ...
            if (
              action === last.key &&
              typeof $keyboard.keyaction[action] === "string"
            ) {
        ...
        .add(
          "." +
            kbcss.keyPrefix +
            "tab bksp space enter".split(" ").join(",." + kbcss.keyPrefix),
          base.$keyboard
        )
        .bind(
          "mousedown touchstart ".split(" ").join(base.namespace + "kb "),
          function() {
            if (o.repeatRate !== 0) {
              var key = $(this);
    ...
    base.insertText = function(txt) {
      ...
      txt = isBksp ? "" : txt;
      val =
        val.substr(0, pos.start - (bksp ? 1 : 0)) + txt + val.substr(pos.end);
    ...
    base.showSet = function(name) {
      ...
      if (base.metaActive) {
        ...
        if (
          (!o.stickyShift && base.last.keyset[2] !== base.metaActive) ||
          ((base.shiftActive || base.altActive) &&
            !base.$keyboard.find(
              "." + kbcss.keySet + "-" + key + base.rows[toShow]
            ).length)
        ) {
        ...
        !o.stickyShift &&
        base.last.keyset[2] !== base.metaActive &&
        base.shiftActive
      ) {
      ...
      toShow = (base.shiftActive ? 1 : 0) + (base.altActive ? 2 : 0);
      key =
        toShow === 0 && !base.metaActive
          ? "-normal"
          : key === ""
            ? ""
            : "-" + key;
      if (
        !base.$keyboard.find("." + kbcss.keySet + key + base.rows[toShow])
          .length
      ) {
    ...
    base.checkCombos = function() {
      ...
      if (o.useCombos) {
        ...
        if ($keyboard.msie) {
          ...
          val = val.replace(base.regex, function(s, accent, letter) {
            return o.combos.hasOwnProperty(accent)
              ? o.combos[accent][letter] || s
              : s;
          });
      ...
      if (o.restrictInput && val !== "") {
        ...
        if (!r) {
          ...
          r = layout.acceptedKeysRegex = new RegExp(
            "(" + t2.join("|") + ")",
            "g"
          );
        }
    ...
    base.checkValid = function() {
      ...
      $accept
        ...
        .attr(
          "title",
          $accept.attr("data-title") +
            " (" +
            o.display[valid ? "valid" : "invalid"] +
            ")"
        );
    };
    ...
    base.close = function(accepted) {
      if (base.isOpen && base.$keyboard.length) {
        ...
        if (!o.alwaysOpen) {
          ...
          base.$el.trigger(kbevents.kbBeforeClose, [
            base,
            base.el,
            accepted || false
          ]);
        ...
        base.$el
          .trigger(
            accepted || false ? kbevents.inputAccepted : kbevents.inputCanceled,
            [base, base.el]
          )
          .trigger(o.alwaysOpen ? kbevents.kbInactive : kbevents.kbHidden, [
            base,
            base.el
          ])
          .blur();
        ...
        if (base) {
          ...
          base.last.eventTime = new Date().getTime();
          if (
            !(o.alwaysOpen || (o.userClosed && accepted === "true")) &&
            base.$keyboard.length
          ) {
            // free up memory
            base.removeKeyboard();
    ...
    base.escClose = function(e, $el) {
      ...
      if (
        (!base.isCurrent() && base.isOpen) ||
        (base.isOpen && $target[0] !== base.el)
      ) {
        // don't close if stayOpen is set; but close if a different keyboard is being opened
        if (
          (o.stayOpen || o.userClosed) &&
          !$target.hasClass($keyboard.css.input)
        ) {
          return;
        }
    ...
    base.addKey = function(keyName, action, regKey) {
      ...
      // add the wide class
      keyClass +=
        (keys.name.length > 2 ? " " + kbcss.keyWide : "") +
        " " +
        o.css.buttonDefault;
    ...
    base.buildKeyboard = function(name, internal) {
      ...
      if (
        (internal && o.layout === "custom") ||
        !$keyboard.layouts.hasOwnProperty(o.layout)
      ) {
        o.layout = "custom";
        ...
        $layout =
          $keyboard.layouts[
            internal ? o.layout : name || base.layout || o.layout
          ];
      }
      ...
      $.each($layout, function(set, keySet) {
        ...
        if (set !== "" && !/^(name|lang|rtl)$/i.test(set)) {
          ...
          for (row = 0; row < keySet.length; row++) {
            ...
            currentSet = $.trim(keySet[row]).replace(
              /\{(\.?)[\s+]?:[\s+]?(\.?)\}/g,
              "{$1:$2}"
            );
            base.buildRow($row, row, currentSet.split(/\s+/), acceptedKeys);
            $row
              .find("." + kbcss.keyButton + ",." + kbcss.keySpacer)
              .filter(":last")
            ...
            case "combo":
              base
                ...
                .attr("title", function(indx, title) {
                  ...
                  return (
                    title + " " + o.display[o.useCombos ? "active" : "disabled"]
                  );
                })
            ...
            default:
              if ($keyboard.keyaction.hasOwnProperty(txt[0])) {
                base
                  .addKey(txt[0], action)
                  .toggleClass(
                    o.css.buttonAction + " " + kbcss.keyAction,
                    isAction
                  );
              }
          }
  ...
  $keyboard.keyaction = {
    ...
    combo: function(base) {
      ...
      $combo
        ...
        .attr(
          "title",
          $combo.attr("data-title") +
            " (" +
            o.display[c ? "active" : "disabled"] +
            ")"
        );
      if (c) {
        base.checkCombos();
    ...
    enter: function(base, el, e) {
      ...
      if (e.shiftKey) {
        ...
        return o.enterNavigation
          ? base.switchInput(!e[o.enterMod], true)
          : base.close(true);
      }
    ...
    if (typeof $keyboard.checkCaret !== "boolean") {
      ...
      var $temp = $(
        '<div style="height:0px;width:0px;overflow:hidden;position:fixed;top:0;left:-100px;">' +
          '<input type="text" value="testing"/></div>'
...
/*! jQuery UI Virtual Keyboard Extender v1.0.3 */ (function(factory) {
  // if (typeof define === "function" && define.amd) {
  //   define(["jquery"], factory);
  // } else if (typeof module === "object" && typeof module.exports === "object") {
  //   module.exports = factory(require("jquery"));
    ...
    return this.each(function() {
      ...
      base.extender_toggle = function(set) {
        base.extender_options.showing =
          typeof set === "undefined" ? !base.extender_options.showing : set;
        base.$keyboard
          ...
          .end()
          .find("div." + $keyboard.css.extender)[0].style.display = base
          .extender_options.showing
          ? "inline-block"
          : "none";
...
var getTextKeyBoard = function(input) {
  // var obj = {
  ...
  jquery(input).keyboard({
    ...
    customLayout: {
      normal: [
        "° 1 2 3 4 5 6 7 8 9 0 - = {bksp}",
        "{tab} q w e r t y u i o p [ ] \\",
        'a s d f g h j k l ñ " ç ´ {accept}',
        "{shift} z x c v b n m , . / {shift}",
        "{cancel} {space} {left} {right} {sp:.2} @ .com"
      ],
      shift: [
        "~ ! ; # $ % ^ & * ( ) _ + {bksp}",
        "{tab} Q W E R T Y U I O P { } :",
    ...
    display: {
      ...
      a: "\u2714:Aceptar:Acceptar el texto Ingresado", // check mark - same action as accept
      accept: "Aceptar:Acceptar el texto Ingresado",
      bksp: " Borrar:Borrar",
    ...
    beforeClose: function() {
      ...
      // column.classList.remove("display-kb");
    },
    visible: function(event, keyLib, input) {
      var input = jquery(input);
      var body = jquery("body");
      global.body = body;
      global.input = input;
      global.keyLib = keyLib;
      ...
      var keyboardHeight = keyLib.$keyboard.outerHeight();
      var keyboardOffset = keyLib.$keyboard.offset();
      // var body =
      var bodyHeight = body.outerHeight();
      if (endPosition + 20 > keyboardOffset.top) {
        var move = endPosition + 20 - keyboardOffset.top;
        body.css("margin-top", -move);
      }
    },
    accepted: function() {
      // if (input.value) {
      //   ConversationPanel.inputKeyDownTrigger(input)
      // }
    },
    // keyboardChange: function () {
    // 	console.log("keyboardChange")
    // },
    change: function(keyboard, data) {
      // resetTimeout();
      // contTimeOut = 0;
      // console.log("change")
      // return data;
...
export default getTextKeyBoard;
