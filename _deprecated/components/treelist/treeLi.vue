<template>
  <li v-if="itemVisible" :class="liClass">
    <div
      class="tree-node-el d-flex flex-wrap"
      :draggable="draggable"
    ...
    >
      <i
        ...
        v-if="showExpand"
        :class="['fas','expand-icon','fa-'+ (item.expanded ? 'caret-down' : 'caret-right')]"
      ></i>
...
export default {
  ...
  methods: {
     ...
     */
    changeNodeCheckStatus(checked) {
      // console.log(arguments);
      // const checked = $event.target.checked;
      // console.log(node);
      // console.log(checked)
      this.nodeCheck(this.item, checked);
      this.emitEventToTree("node-check", this.item, checked, this.position);
    },
