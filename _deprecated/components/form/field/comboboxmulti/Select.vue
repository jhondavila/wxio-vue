...
.v-select[dir="rtl"] .dropdown-togglems .clear {
  margin-left: 6px;
  margin-right: 0;
}
...
/* Clear Button */
.v-select .dropdown-togglems .clear {
  font-size: 23px;
  font-weight: 700;
  line-height: 1;
...
.v-select.searchable .dropdown-togglems {
  cursor: text;
}
.v-select.unsearchable .dropdown-togglems {
  cursor: pointer;
}
.v-select.open .dropdown-togglems {
...
.v-select .input-multi {
  height: calc(2.25rem);
}

.v-select .input-multi[readonly] {
  background-color: #ffffff;
}

.v-select .custom-checkbox:hover {
  cursor: pointer;
}
.v-select .custom-control-input:hover {
  cursor: pointer;
}
.v-select .custom-control-label:hover {
  cursor: pointer;
}

/* Disabled state */
.v-select.disabled .dropdown-togglems,
.v-select.disabled .dropdown-togglems .clear,
.v-select.disabled .dropdown-togglems input,
...
<template>
  <div :dir="dir" class="dropdown v-select" :class="dropdownClasses">
    <div ref="toggle" @mousedown.prevent="toggleDropdown" class="dropdown-togglems">
      <div class="vs__selected-options" ref="selectedOptions">
        ...
        <input
          ref="search"
          :value="valueAsArray.map(i=>i[label])"
          ...
          @focus="onSearchFocus"
          type="text"
          class="form-control input-multi"
          autocomplete="off"
          :disabled="disabled"
        ...
        >
          <a @mousedown.prevent.stop="select(option)">
            <div class="custom-control custom-checkbox">
              ...
              >
              <label class="custom-control-label">{{ getOptionLabel(option) }}</label>
            </div>

            <!-- <input type="checkbox" class="custom-control-input"> -->
            <!-- <b-form-checkbox :checked="isOptionSelected(option)">{{ getOptionLabel(option) }}</b-form-checkbox> -->
            <!-- <slot
              name="option"
...
export default {
  ...
  methods: {
    ...
    isOptionSelected(option) {
      // console.log(option)
      let selected = false;
      // let list = this.valueAsArray;

      return this.valueAsArray.some(value => {
        // debugger
        // console.log(value.id);
        if (typeof value === "object") {
          return (selected = this.optionObjectComparator(value, option));
