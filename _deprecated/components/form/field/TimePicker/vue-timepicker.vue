...
<div class="time-picker">
  ...
  <b-input-group>
    <input class="display-time form-control" :id="id" v-model="displayTime" @click.stop="toggleDropdown" type="text" readonly />
  ...
  <div class="dropdown" v-show="showDropdown">
    <div class="select-list">
      <ul class="hours">
        ...
        <li v-for="hr in hours" :key="hr" v-text="hr" :class="{active: hour === hr}" @click.stop="select('hour', hr)"></li>
      </ul>
      <ul class="minutes">
        <li class="hint" v-text="minuteType"></li>
        <li v-for="m in minutes" v-text="m" :key="m" :class="{active: minute === m}" @click.stop="select('minute', m)"></li>
      </ul>
      <ul class="seconds" v-if="secondType">
        <li class="hint" v-text="secondType"></li>
        <li v-for="s in seconds" v-text="s" :key="s" :class="{active: second === s}" @click.stop="select('second', s)"></li>
      </ul>
      <ul class="apms" v-if="apmType">
        <li class="hint" v-text="apmType"></li>
        <li v-for="a in apms" v-text="a" :key="a" :class="{active: apm === a}" @click.stop="select('apm', a)"></li>
      </ul>
    </div>
  </div>
</div>
